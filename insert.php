...
// データベースへの接続情報
$servername = "mysql57.kazuyaarimori06.sakura.ne.jp";
...
try {
  ...
  // SQL文の準備と実行
  $stmt = $pdo->prepare("INSERT INTO gs_bm_table (bookname, bookwriter, bookurl, bookcomment, regdate) VALUES (:bookname, :bookwriter, :bookurl, :bookcomment, :regdate)");
